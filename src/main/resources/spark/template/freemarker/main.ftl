    ...
    <body>
        ...
        <ol class="step">
            ...
            <div id="big_0" class="stacked">
                <h1 style="color:blue;"> Welcome to the Markov Style Hunter! Follow the instructions below to select your facets and craft a custom phrase.</h1>
            </div>
